...
class FastAPIApp:
    ...
    def add_routes(self):
        ...
        @self.app.get("/v2/assignment/{assignment_id}", response_model=schemas.AssignmentCreate)
        ...
        @self.app.post("/v2/assignments/{assignment_id}/submission", response_model=schemas.SubmissionResponse,status_code=201)
